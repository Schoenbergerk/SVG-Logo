...
render(){
     ...
     <text x="150" y="120" font-size="60" text-anchor="middle" fill="${this.textColor}">${this.userLetters}</text>
...
render(){
     ...
     <text x="150" y="145" font-size="60" text-anchor="middle"" fill="${this.textColor}">${this.userLetters}</text>
     </svg>`
}
};
